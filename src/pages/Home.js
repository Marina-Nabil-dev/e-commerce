        ...
        >
          ...
          <div className="flex flex-col items-center p-[250px_80px_40px_80px] justify-center">
            ...
            <h2 className="text-2xl font-semibold items-center w-auto">
              We are a platform that is user-friendly, making it easy to sell or
              buy a car without any hassle. Additionally, we provide you with a
              variety of sales, including auction sales.
            </h2>
          </div>
